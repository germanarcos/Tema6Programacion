...
public class GestionLibroAutor {
	public static void main(String[] args) {
		...
		do {
			...
			switch (opcion){
			case 1:
				Autor autor = new Autor(Leer.pedirCadena("Introduce el autor"),Leer.pedirCadena("Introduce el email del autor") ,Leer.pedirCadena("Introduce el género").charAt(0));
				listadoLibros.add(new Libro(Leer.pedirCadena("Introduce el título"), autor, Leer.pedirDouble("Introduce el precio"),Leer.pedirEntero("Introduce la cantidad")));
//				listadoLibros.add();
